...
!function (e, a, t) {
    ...
    function x(a, t) {
        var n = e("li.dir", "ul.grid").filter(":visible"), i = e("li.file", "ul.grid").filter(":visible"), r = [],
            o = [], l = [], c = [];
        n.each(function () {
    ...
    var j = "9.9.7", T = !0, I = 0, O = function () {
        var e = 0;
        return function (a, t) {
        ...
        contextActions: {
            copy_url: function (a) {
                ...
                var t = a.attr("data-name"), n = e("#base_url_true").val() + e("#cur_dir").val() + t,
                    i = e("#aviary_img");
                ...
                var t, n = S(a), i = e("#field_id").val(), r = e("#return_relative_url").val();
    ...
    e(document).ready(function () {
        ...
        var i = e("#cur_dir").val(), r = e("#subdir").val(), o = e("#base_url").val(),
            l = a.substr(0, a.lastIndexOf(".")), c = a.split(".").pop();
        c = c.toLowerCase();
        var s = "", d = ["ogg", "mp3", "wav"], p = ["mp4", "ogg", "webm"], f = e("#return_relative_url").val(),
            u = encodeURL((1 == f ? r : o + i) + a);
        uploads_file_material_log(u,$('#material_guid').val());
        ...
        var c = a.find("a.rename-file"), s = a.find("a.delete-file"), d = c.attr("data-path"),
            p = d.replace(r, t + "." + o);
        ...
        a.find("h4 > a").text(t);
        var i = a.find(".folder-link"), r = i.attr("href"), o = e("#fldr_value").val(),
            l = r.replace("fldr=" + o + encodeURIComponent(n), "fldr=" + o + encodeURIComponent(t));
        i.each(function () {
            e(this).attr("href", l)
        });
        var c = a.find("a.delete-folder"), s = a.find("a.rename-folder"), d = s.attr("data-path"),
            p = d.lastIndexOf("/"), f = d.substr(0, p + 1) + t;
