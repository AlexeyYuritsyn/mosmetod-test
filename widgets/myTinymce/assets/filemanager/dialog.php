...
//	    }
        ...
        <script src="/../../js/uploadsFileMaterialLog/uploads-file-material-log.js"></script>
	    <script src="js/include.js"></script>

<script>
        // function test_test_test(url) {
        // test_test_test_test(url);
        // console.log(url);
        // }
...
<body>
    ...
    <input type="hidden" id="material_guid" value="<?= $material_guid ?>" />
<?php if($upload_files){ ?>
<!-- uploader div start -->
<div class="uploader">
            ...
            ?>		<figure data-name="<?php echo $file ?>" data-type="<?php if($is_img){ echo "img"; }else{ echo "file"; } ?>">
				...
				<div class="img-precontainer">
				    ...
				    <div class="img-container">
					    <span></span>
					    <img class="<?php echo $show_original ? "original" : "" ?><?php echo $is_icon_thumb ? " icon" : "" ?><?php echo $lazy_loading_enabled ? " lazy-loaded" : ""?>" <?php if($is_icon_thumb == false){ ?> data-original="<?php echo $src; ?>" src="<?php echo $src; ?>" <?php } ?>  >
<!--                        --><?php //echo $lazy_loading_enabled ? "data-original" : "src"?><!--="--><?php //echo $src; ?><!--"-->
				    </div>
				</div>
				<div class="img-precontainer-mini <?php if($is_img) echo 'original-thumb' ?>">
					...
					<span></span>
					<?php if($mini_src!=""){ ?>
					<img class="<?php echo $show_original_mini ? "original" : "" ?><?php echo $is_icon_thumb_mini ? " icon" : "" ?><?php echo $lazy_loading_enabled ? " lazy-loaded" : ""?>"  data-original="<?php echo $src; ?>" src="<?php echo $src; ?>">
					<?php } ?>
				    </div>
				</div>
