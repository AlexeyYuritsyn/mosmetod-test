...
$config = array(
	...
	*/
	...
	'material_guid' => $uploadPath['material_guid'],
...
//	'ext_misc'                                => array( 'zip', 'rar', 'gz', 'tar', 'iso', 'dmg' ), //Archives
    ...
    /******************
     * !!!!!!!!!!!!!!!!Если расширения не написаны, а файлы есть то будет их считать, но всписке не показывать !!!!!!!!!!!!!!!!!!!
     *******************/

	'ext_img'                                 => array( 'jpg', 'jpeg', 'png'), //Images
	'ext_file'                                => array( 'doc', 'docx', 'pdf', 'xls', 'xlsx', 'txt', 'csv','xml','ppt', 'pptx'), //Files
