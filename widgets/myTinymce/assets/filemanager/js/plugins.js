!function (e, t) {
    ...
    function o(e, n, i, o) {
        if (lt.acceptData(e)) {
            var r, s, a = lt.expando, l = "string" == typeof n, c = e.nodeType, u = c ? lt.cache : e,
                d = c ? e[a] : e[a] && a;
    ...
    function $(e, t, n) {
        var i = !0, o = "width" === t ? e.offsetWidth : e.offsetHeight, r = dn(e),
    ...
    var U, X, Y = typeof t, Q = e.document, K = e.location, G = e.jQuery, V = e.$, J = {}, Z = [], et = "1.9.1",
        tt = Z.concat, nt = Z.push, it = Z.slice, ot = Z.indexOf, rt = J.toString, st = J.hasOwnProperty, at = et.trim,
        lt = function (e, t) {
            return new lt.fn.init(e, t, X)
        }, ct = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, ut = /\S+/g, dt = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,
        pt = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/, ht = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, ft = /^[\],:{}\s]*$/,
        mt = /(?:^|:|,)(?:\s*\[)+/g, gt = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,
    ...
    lt.Callbacks = function (e) {
        ...
        Deferred: function (e) {
            ...
            var t, n, i, o = 0, r = it.call(arguments), s = r.length,
                a = 1 !== s || e && lt.isFunction(e.promise) ? s : 0, l = 1 === a ? e : lt.Deferred(),
                c = function (e, n, i) {
                    return function (o) {
    ...
    var $t, Nt, _t = /[\t\r\n]/g, St = /\r/g, Dt = /^(?:input|select|textarea|button|object)$/i, At = /^(?:a|area)$/i,
        ...
        Lt = /^(?:checked|selected)$/i, Pt = lt.support.getSetAttribute, Ft = lt.support.input;
    lt.fn.extend({
        attr: function (e, t) {
        ...
        get: function (e, n) {
            var i = lt.prop(e, n), o = "boolean" == typeof i && e.getAttribute(n),
    ...
    var Ot = /^(?:input|select|textarea)$/i, It = /^key/, Ht = /^(?:mouse|contextmenu)|click/,
        jt = /^(?:focusinfocus|focusoutblur)$/, zt = /^([^.]*)(?:\.(.+)|)$/;
    lt.event = {
        global: {},
        ...
        trigger: function (n, i, o, r) {
            var s, a, l, c, u, d, p, h = [o || Q], f = st.call(n, "type") ? n.type : n,
        ...
        dispatch: function (e) {
            e = lt.event.fix(e);
            var n, i, o, r, s, a = [], l = it.call(arguments), c = (lt._data(this, "events") || {})[e.type] || [],
        ...
        function g(e, t, n, i, r, s) {
            return i && !i[j] && (i = g(i)), r && !r[j] && (r = g(r, s)), o(function (o, s, a, l) {
                var c, u, d, p = [], h = [], f = s.length, g = o || b(t || "*", a.nodeType ? [a] : a, []),
                    v = !e || !o && t ? g : m(g, p, e, a, l), y = n ? r || (o ? e : f || i) ? [] : s : v;
        ...
        function y(e, t) {
            var n = 0, i = t.length > 0, r = e.length > 0, a = function (o, a, l, c, u) {
                var d, p, h, f = [], g = 0, v = "0", y = o && [], b = null != u, w = S,
                    x = o || r && T.find.TAG("*", u && a.parentNode || a), C = R += null == w ? 1 : Math.random() || .1;
        ...
        var C, k, T, E, $, N, _, S, D, A, M, L, P, F, O, I, H, j = "sizzle" + -new Date, z = e.document, W = {}, R = 0,
            B = 0, q = i(), U = i(), X = i(), Y = typeof t, Q = 1 << 31, K = [], G = K.pop, V = K.push, J = K.slice,
            ...
            gt = /^(?:input|select|textarea|button)$/i, vt = /^h\d$/i, yt = /'|\\/g,
            ...
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === i && 0 === o ? function (e) {
                        ...
                        var c, u, d, p, h, f, m = r !== s ? "nextSibling" : "previousSibling", g = t.parentNode,
    ...
    var Wt = /Until$/, Rt = /^(?:parents|prev(?:Until|All))/, Bt = /^.[^:#\[\.,]*$/, qt = lt.expr.match.needsContext,
    ...
    var Xt = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        Yt = / jQuery\d+="(?:null|\d+)"/g, Qt = new RegExp("<(?:" + Xt + ")[\\s/>]", "i"), Kt = /^\s+/,
        Gt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Vt = /<([\w:]+)/,
        Jt = /<tbody/i, Zt = /<|&#?\w+;/, en = /<(?:script|style|link)/i, tn = /^(?:checkbox|radio)$/i,
        nn = /checked\s*(?:[^=]|=\s*.checked.)/i, on = /^$|\/(?:java|ecma)script/i, rn = /^true\/(.*)/,
        sn = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, an = {
    ...
    var un, dn, pn, hn = /alpha\([^)]*\)/i, fn = /opacity\s*=\s*([^)]*)/, mn = /^(top|right|bottom|left)$/,
        gn = /^(none|table(?!-c[ea]).+)/, vn = /^margin/, yn = new RegExp("^(" + ct + ")(.*)$", "i"),
        bn = new RegExp("^(" + ct + ")(?!px)[a-z%]+$", "i"), wn = new RegExp("^([+-])=(" + ct + ")", "i"),
        xn = {BODY: "block"}, Cn = {position: "absolute", visibility: "hidden", display: "block"},
        kn = {letterSpacing: 0, fontWeight: 400}, Tn = ["Top", "Right", "Bottom", "Left"],
        En = ["Webkit", "O", "Moz", "ms"];
    lt.fn.extend({
        css: function (e, n) {
        ...
        get: function (e, t) {
            ...
            var n = e.style, i = e.currentStyle, o = lt.isNumeric(t) ? "alpha(opacity=" + 100 * t + ")" : "",
    ...
    var An, Mn, Ln = lt.now(), Pn = /\?/, Fn = /#.*$/, On = /([?&])_=[^&]*/, In = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
        Hn = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, jn = /^(?:GET|HEAD)$/, zn = /^\/\//,
        Wn = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, Rn = lt.fn.load, Bn = {}, qn = {}, Un = "*/".concat("*");
    try {
        Mn = K.href
    } catch (Xn) {
    ...
    An = Wn.exec(Mn.toLowerCase()) || [], lt.fn.load = function (e, n, i) {
        ...
        ajax: function (e, n) {
            ...
            var o, r, s, a, l, c, u, d, p = lt.ajaxSetup({}, n), h = p.context || p,
                f = p.context && (h.nodeType || h.jquery) ? lt(h) : lt.event, m = lt.Deferred(),
                g = lt.Callbacks("once memory"), v = p.statusCode || {}, y = {}, b = {}, w = 0, x = "canceled", C = {
    ...
    lt.ajaxSetup({
        ...
        var r, s, a,
            l = n.jsonp !== !1 && (Qn.test(n.url) ? "url" : "string" == typeof n.data && !(n.contentType || "").indexOf("application/x-www-form-urlencoded") && Qn.test(n.data) && "data");
    ...
    var Zn, ei, ti = /^(?:toggle|show|hide)$/, ni = new RegExp("^(?:([+-])=|)(" + ct + ")([a-z%]*)$", "i"),
        ii = /queueHooks$/, oi = [W], ri = {
            "*": [function (e, t) {
    ...
    lt.Animation = lt.extend(j, {
        ...
        fadeTo: function (e, t, n, i) {
            ...
            return e !== !1 && (e = e || "fx"), this.each(function () {
                var t, n = lt._data(this), i = n[e + "queue"], o = n[e + "queueHooks"], r = lt.timers,
                    s = i ? i.length : 0;
        ...
        setOffset: function (e, t, n) {
            ...
            var o, r, s = lt(e), a = s.offset(), l = lt.css(e, "top"), c = lt.css(e, "left"),
                u = ("absolute" === i || "fixed" === i) && lt.inArray("auto", [l, c]) > -1, d = {}, p = {};
    ...
    t.prototype.checkPosition = function () {
        if (this.$element.is(":visible")) {
            var t, n = e(document).height(), i = this.$window.scrollTop(), o = this.$element.offset(),
                r = this.options.offset, s = r.bottom, a = r.top, l = "affix affix-top affix-bottom";
    ...
    e.fn.collapse = function (n) {
        return this.each(function () {
            var i = e(this), o = i.data("collapse"),
    ...
    e.fn.modal = function (n) {
        ...
        var n = e(this), i = n.attr("href"), o = e(n.attr("data-target") || i && i.replace(/.*(?=#[^\s]+$)/, "")),
    ...
    t.prototype = {
        constructor: t, refresh: function () {
            ...
            var e, t = this.$scrollElement.scrollTop() + this.options.offset,
                ...
                i = n - this.$scrollElement.height(), o = this.offsets, r = this.targets, s = this.activeTarget;
    ...
    e.fn.lightbox = function (n) {
        return this.each(function () {
            var i = e(this), o = i.data("lightbox"),
    ...
    var s = null, a = !1, l = e(window), c = 0, u = {}, d = {}, p = {}, h = {
        ...
        position: function (e, t, n) {
            ...
            var o = l.scrollTop() + l.height(), r = l.scrollLeft() + l.width(), s = e.$menu.height(),
                a = e.$menu.width();
        ...
        show: function (t, n, i) {
            ...
            i === t && (i = n, v.resize(n.$menu)), n.$menu.children().each(function () {
                var t = e(this), r = t.data("contextMenuKey"), s = n.items[r],
...
var bootbox = window.bootbox || function (e, t) {
    ...
    d.setLocale = function (e) {
        ...
        for (var p = i.length; p--;) {
            ...
            "function" == typeof i[p].callback && (v = i[p].callback), i[p]["class"] ? m = i[p]["class"] : p == i.length - 1 && i.length <= 2 && (m = "btn-primary"), i[p].link !== !0 && (m = "btn " + m), h = i[p].label ? i[p].label : "Option " + (p + 1), i[p].icon && (g = "<i class='" + i[p].icon + "'></i> "), f = i[p].href ? i[p].href : a, u = "<a data-handler='" + p + "' class='" + m +(p == 1?" confirm-changes-file ":"")+ "' href='" + f + "'>" + g + h + "</a>" + u, d[p] = v
        }
...
window.bootbox = bootbox, function () {
    ...
    function n(t, n) {
        ...
        var St = T || $ || !n.fallbackToMouseEvents,
            ...
            Mt = St ? $ ? E ? "MSPointerUp" : "pointerup" : "touchend" : "mouseup", Lt = St ? null : "mouseleave",
            Pt = $ ? E ? "MSPointerCancel" : "pointercancel" : "touchcancel", Ft = 0, Ot = null, It = 0, Ht = 0, jt = 0,
            zt = 1, Wt = 0, Rt = 0, Bt = null, qt = e(t), Ut = "start", Xt = 0, Yt = null, Qt = 0, Kt = 0, Gt = 0,
            Vt = 0, Jt = 0, Zt = null, en = null;
        try {
    ...
    var i = "left", o = "right", r = "up", s = "down", a = "in", l = "out", c = "none", u = "auto", d = "swipe",
        p = "pinch", h = "tap", f = "doubletap", m = "longtap", g = "horizontal", v = "vertical", y = "all", b = 10,
        w = "start", x = "move", C = "end", k = "cancel", T = "ontouchstart" in window,
        E = window.navigator.msPointerEnabled && !window.navigator.pointerEnabled,
        $ = window.navigator.pointerEnabled || window.navigator.msPointerEnabled, N = "TouchSwipe", _ = {
            fingers: 1,
            threshold: 75,
    ...
    "use strict";
    var n, i, o = e, r = o.document, s = o.navigator, a = o.setTimeout, l = o.encodeURIComponent, c = o.ActiveXObject,
        u = o.Error, d = o.Number.parseInt || o.parseInt, p = o.Number.parseFloat || o.parseFloat,
        h = o.Number.isNaN || o.isNaN, f = o.Math.round, m = o.Date.now, g = o.Object.keys, v = o.Object.defineProperty,
        y = o.Object.prototype.hasOwnProperty, b = o.Array.prototype.slice, w = function () {
            var e = function (e) {
                return e
            };
            ...
            if (e && /^_(?:click|mouse(?:over|out|down|up|move))$/.test(e.type)) {
                var n = e.target, i = "_mouseover" === e.type && e.relatedTarget ? e.relatedTarget : t,
                    s = "_mouseout" === e.type && e.relatedTarget ? e.relatedTarget : t, a = $t(n),
                    l = o.screenLeft || o.screenX || 0, c = o.screenTop || o.screenY || 0,
                    ...
                    h = a.top + ("number" == typeof e._stageY ? e._stageY : 0), f = p - u, m = h - d, g = l + f, v = c + m,
            ...
            if (!t) {
                var i = wt(o.location.host, z), s = "never" === i ? "none" : "all", a = yt(z),
    ...
    var It = function (e) {
        ...
        var t = Lt[this.id] && Lt[this.id].elements, n = !!t && t.length > 0,
            i = !e.target || n && -1 !== t.indexOf(e.target),
            o = e.relatedTarget && n && -1 !== t.indexOf(e.relatedTarget), r = e.client && e.client === this;
        return i || o || r ? !0 : !1
    }, Yt = function (e) {
        if ("object" == typeof e && e && e.type) {
            var t = st(e), n = Lt[this.id] && Lt[this.id].handlers["*"] || [],
                i = Lt[this.id] && Lt[this.id].handlers[e.type] || [], r = n.concat(i);
            if (r && r.length) {
                var s, a, l, c, u, d = this;
                for (s = 0, a = r.length; a > s; s++) l = r[s], c = d, "string" == typeof l && "function" == typeof o[l] && (l = o[l]), "object" == typeof l && l && "function" == typeof l.handleEvent && (c = l, l = l.handleEvent), "function" == typeof l && (u = C({}, e), at(l, c, [u], t))
            }
    ...
    e.ui = e.ui || {};
    var r, s = Math.max, a = Math.abs, l = Math.round, c = /left|center|right/, u = /top|center|bottom/,
    ...
    e.position = {
        ...
        t = e.extend({}, t);
        var r, h, m, g, v, y, b = e(t.of), w = e.position.getWithinInfo(t.within), x = e.position.getScrollInfo(w),
            C = (t.collision || "flip").split(" "), k = {};
        return y = o(b), b[0].preventDefault && (t.at = "left top"), h = y.width, m = y.height, g = y.offset, v = e.extend({}, g), e.each(["my", "at"], function () {
            ...
            var o, c, u = e(this), d = u.outerWidth(), p = u.outerHeight(), f = i(this, "marginLeft"),
                y = i(this, "marginTop"), T = d + f + i(this, "marginRight") + x.width,
                E = p + y + i(this, "marginBottom") + x.height, $ = e.extend({}, v),
            ...
            "right" === t.my[0] ? $.left -= d : "center" === t.my[0] && ($.left -= d / 2), "bottom" === t.my[1] ? $.top -= p : "center" === t.my[1] && ($.top -= p / 2), $.left += N[0], $.top += N[1], e.support.offsetFractions || ($.left = l($.left), $.top = l($.top)), o = {
                ...
                var n = g.left - $.left, i = n + h - d, o = g.top - $.top, r = o + m - p, l = {
                    target: {element: b, left: g.left, top: g.top, width: h, height: m},
        ...
        fit: {
            ...
            left: function (e, t) {
                var n, i, o = t.within, r = o.offset.left + o.scrollLeft, s = o.width,
                    ...
                    u = c - l, d = c + t.collisionWidth - s - l,
                ...
                var n, i, o = t.within, r = o.offset.top + o.scrollTop, s = o.height,
                    ...
                    d = c + t.collisionHeight - s - l, p = "top" === t.my[1],
    ...
    e.widget("ui.draggable", e.ui.mouse, {
        ...
        start: function () {
            ...
            var i, o, r, s, a, l, c, u, d, p, h = e(this).data("ui-draggable"), f = h.options, m = f.snapTolerance,
                g = n.offset.left, v = g + h.helperProportions.width, y = n.offset.top,
    ...
    e.widget("ui.droppable", {
        ...
        var o, r, s = (e.positionAbs || e.position.absolute).left, a = (e.positionAbs || e.position.absolute).top,
            l = s + e.helperProportions.width, c = a + e.helperProportions.height, u = n.offset.left, d = n.offset.top,
            p = u + n.proportions().width, h = d + n.proportions().height;
        switch (i) {
            case"fit":
